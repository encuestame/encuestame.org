        ...
        <div class="container-fluid">
            ...
            <div class="nav-collapse">
                <ul class="nav pills">
                    ...
                    <li class="<c:out value="${menu == 'source' ? 'active' : ''}"/>"><a href="<c:url value="/source" />"><spring:message code="source"/></a></li>
                    ...
                    <li class="<c:out value="${menu == 'about' ? 'active' : ''}"/>"><a href="<c:url value="/about" />"><spring:message code="about"/></a></li>
                    <li class="<c:out value="${menu == 'interest' ? 'active' : ''}"/> dropdown" id="menu1"><a class="dropdown-toggle"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="http://code.encuestame.org"><spring:message code="more.browse"/></a>
                            </li>
                            <li><a href="http://stats.encuestame.org/git"><spring:message code="more.stats"/></a>
                            </li>
